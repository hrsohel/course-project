           ...
           <main className='flex items-start justify-center bg-gray-200'>
                ...
                <div className="instructor w-full">
                    ...
                    <div className='flex items-center justify-around p-4 flex-wrap'>
                        <div className="card shadow-xl w-80 rounded-md  bg-white">
                        ...
                        <div className="card shadow-xl my-4 lg:my-0 w-80 bg-white rounded-md ">
                        ...
                        <div className="card shadow-xl bg-white w-80 rounded-md ">
